                                ...
                                bool flag)
{
    SplitLine_print('-');  
    if (flag == true){
        cout << ">>> generate a well-formed 1-message 3-recipient twisted ElGamal ciphertext" << endl; 
    }
    else{
         cout << ">>> generate an ill-formed 1-message 3-recipient twisted ElGamal ciphertext" << endl; 
    }
    ...
    ECP_random(instance.pk3);

    Twisted_ElGamal_PP enc_pp; 
    enc_pp.g = pp.g; 
    enc_pp.h = pp.h; 
    Triple_Twisted_ElGamal_CT CT; 
    Triple_Twisted_ElGamal_CT_new(CT); 
    Triple_Twisted_ElGamal_Enc(enc_pp, instance.pk1, instance.pk2, instance.pk3, witness.v, witness.r, CT); 
    
    EC_POINT_copy(instance.X1, CT.X1); 
    EC_POINT_copy(instance.X2, CT.X2); 
    EC_POINT_copy(instance.X3, CT.X3); 
    ...
    Triple_Twisted_ElGamal_CT_free(CT); 
}
